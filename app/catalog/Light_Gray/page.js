...
export default function PantsPage() {
    ...
    return (
        <>
            ...
            <ItemPage size={size} png={png} color={color} displayColor={displayColor} page="pants" imgs={imgs} title="Catalog/Pants" itemName="COZY OVERSIZE LIGHT GRAY PANTS UNISEX"
