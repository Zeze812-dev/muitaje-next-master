...
export default function PantsPage() {
    ...
    return (
        <>
            ...
            <ItemPage size={size} png={png} color={color} imgs={imgs} title="Catalog/Pants" itemName="COZY OVERSIZE GRAY PANTS UNISEX"
                      about1="Без ожиданий для L, M. Отправка в течение 2-3 дней. В наличии 2шт (1 шт - S, 1 шт - M). "
