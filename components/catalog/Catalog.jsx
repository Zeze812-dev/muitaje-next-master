...
import fireHover from "@/assets/catalog/fire.png"
import fire from "@/assets/catalog/fire2.png"
            ...
            <div className="mx-3 mb-3 bg-white border-r-2 border-b-2 border-stone-100 overflow-auto flex-1">
                <div className=" border-l-2  border-t-2 border-stone-400">
                    <div className="border-r-2 border-b-2 border-stone-300">
                        <main className=" font-basis33 border-l-2 heightphonecatalog heightcatalog border-t-2 border-stone-600 p-4 grid-cols-2 grid md:grid-cols-3 xl:grid-cols-4">
