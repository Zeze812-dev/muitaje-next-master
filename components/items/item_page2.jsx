                ...
                <div className="relative">
                    ...
                    <div className=" sm:flex md:px-10">
                        ...
                        <div className="absolute w-screen clear-right h-96 phoneright0  " >
                            <div className="relative w-screen phonetp500 mrtopfire h-96">
                                {children}
                            </div>
                        </div>
                    </div>

                    <div className="phonemarginb700 topm0 absolute h-80 w-full flex justify-center text-center">
                        <div className="z-20">
                            <WinButton onClick={addToCartAndOpenPopup}>I want it!</WinButton>

                            {(size.length !== 0) && "Choose your color"}
                            ...
                            {(color.length !== 0) && "Choose our other color"}
                            <div className="flex justify-center gap-2 text-3xl">
                                {color.map((c, index) => (
                                    <button
