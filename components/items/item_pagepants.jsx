            ...
            <div className="relative bg-gradient-dark text-white overflow-auto h-screen">
                <div className="relative">
                    ...
                    <div className=" sm:flex md:px-10">
                        ...
                        <div className="absolute w-screen clear-right h-96 phoneright0 mt-96 " >
                    ...
                    <div className="phonemarginb1000 topm0 absolute h-80 w-full flex justify-center text-center">
                        <div className="z-20">
